...
#define FUNC(sz)                                               \
    {                                                          \
        ...
        state->gp_regs[insn->rd] = *(sz *)TO_HOST(addr);       \
    }

/* lb: load byte */
static void func_lb(state_t *state, insn_t *insn) { FUNC(i8); }

/* lh: load half word */
static void func_lh(state_t *state, insn_t *insn) { FUNC(i16); }

/* lw: load word */
static void func_lw(state_t *state, insn_t *insn) { FUNC(i32); }

/* ld: load double word */
static void func_ld(state_t *state, insn_t *insn) { FUNC(i64); }

/* lbu: load byte */
static void func_lbu(state_t *state, insn_t *insn) { FUNC(u8); }

/* lhu: load half word */
static void func_lhu(state_t *state, insn_t *insn) { FUNC(u16); }

/* lwu: load word */
static void func_lwu(state_t *state, insn_t *insn) { FUNC(u32); }
...
/* NOP */
static void func_addi(state_t *state, insn_t *insn) { FUNC(rs1 + imm); }
...
static void func_xori(state_t *state, insn_t *insn) { FUNC(rs1 & imm); }
...
static void func_ori(state_t *state, insn_t *insn) { FUNC(rs1 | (u64)imm); }

static void func_andi(state_t *state, insn_t *insn) { FUNC(rs1 & (u64)imm); }
...
static void func_sb(state_t *state, insn_t *insn) { FUNC(u8); }

static void func_sh(state_t *state, insn_t *insn) { FUNC(u16); }

static void func_sw(state_t *state, insn_t *insn) { FUNC(u32); }

static void func_sd(state_t *state, insn_t *insn) { FUNC(u64); }
...
static void func_add(state_t *state, insn_t *insn) { FUNC(rs1 + rs2); }
...
static void func_xor(state_t *state, insn_t *insn) { FUNC(rs1 ^ rs2); }

static void func_srl(state_t *state, insn_t *insn) {
    FUNC(rs1 >> (rs2 & 0x3f));
}

static void func_or(state_t *state, insn_t *insn) { FUNC(rs1 | rs2); }

static void func_and(state_t *state, insn_t *insn) { FUNC(rs1 & rs2); }

static void func_mul(state_t *state, insn_t *insn) { FUNC(rs1 * rs2); }

static void func_mulh(state_t *state, insn_t *insn) { FUNC(mulh(rs1, rs2)); }

static void func_mulhsu(state_t *state, insn_t *insn) {
    FUNC(mulhsu(rs1, rs2));
}

static void func_mulhu(state_t *state, insn_t *insn) { FUNC(mulhu(rs1, rs2)); }

static void func_sub(state_t *state, insn_t *insn) { FUNC(rs1 - rs2); }
...
static void func_jalr(state_t *state, insn_t *insn) {
    ...
    state->exit_reason = INDIRECT_JMP;
...
static void func_fadd_s(state_t *state, insn_t *insn) { FUNC(rs1 + rs2); }

static void func_fsub_s(state_t *state, insn_t *insn) { FUNC(rs1 - rs2); }

static void func_fmul_s(state_t *state, insn_t *insn) { FUNC(rs1 * rs2); }

static void func_fdiv_s(state_t *state, insn_t *insn) { FUNC(rs1 / rs2); }

static void func_fsqrt_s(state_t *state, insn_t *insn) { FUNC(sqrtf(rs1)); }
...
static void func_fadd_d(state_t *state, insn_t *insn) { FUNC(rs1 + rs2); }

static void func_fsub_d(state_t *state, insn_t *insn) { FUNC(rs1 - rs2); }

static void func_fmul_d(state_t *state, insn_t *insn) { FUNC(rs1 * rs2); }

static void func_fdiv_d(state_t *state, insn_t *insn) { FUNC(rs1 / rs2); }

static void func_fsqrt_d(state_t *state, insn_t *insn) { FUNC(sqrt(rs1)); }
...
static void func_fcvt_wu_s(state_t *state, insn_t *insn) {
    state->gp_regs[insn->rd] =
        (i64)(i32)(u32)llrintf(state->fp_regs[insn->rs1].f);
}
...
static void func_fcvt_wu_d(state_t *state, insn_t *insn) {
    state->gp_regs[insn->rd] =
        (i64)(i32)(u32)llrint(state->fp_regs[insn->rs1].d);
}
...
static void func_feq_s(state_t *state, insn_t *insn) { FUNC(rs1 == rs2); }

static void func_flt_s(state_t *state, insn_t *insn) { FUNC(rs1 < rs2); }

static void func_fle_s(state_t *state, insn_t *insn) { FUNC(rs1 <= rs2); }
...
static void func_feq_d(state_t *state, insn_t *insn) { FUNC(rs1 == rs2); }

static void func_flt_d(state_t *state, insn_t *insn) { FUNC(rs1 < rs2); }

static void func_fle_d(state_t *state, insn_t *insn) { FUNC(rs1 <= rs2); }
...
static func_t *funcs[] = {
    ...
    func_lbu,       func_lhu,      func_lwu,       func_empty,
    func_empty,     func_addi,     func_slli,      func_slti,
    ...
    func_ecall,     func_csrrc,    func_csrrci,    func_csrrs,
    func_csrrsi,    func_csrrw,    func_csrrwi,    func_flw,
